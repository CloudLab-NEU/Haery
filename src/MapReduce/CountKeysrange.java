...
public class CountKeysrange {
	...
	public static class Map extends Mapper<LongWritable, Text, Text, Text> {
	 ...
	 public void countRange() throws IOException, ClassNotFoundException, InterruptedException {

			Scanner scanner = new Scanner(System.in);
			System.out.println("please input the filepath which the data are stored");
			String filepath = scanner.nextLine();
			System.out.println("then input the key you want to know:");
			...
			job.setJarByClass(CountKeysrange.class);
